...
public class ClientController extends Thread {
    ...
    public ClientController(ObjectInputStream in, ObjectOutputStream out, Socket s, int uniqueId) {
        this.in = in;
        this.out = out;
        this.s = s;
    ...
    public void run() {
        String command;
        System.out.println("Waiting for client commands: "+uniqueId);
//        try {
...
//        }
        ...
        //veio fim
        try {
            System.out.println("Client "+uniqueId+" disconnected");
            in.close();
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
